using System;
 ...
 // Implementation of the Publisher–Subscriber design pattern:
// This event allows the UserControl (Publisher) to notify the Form (Subscriber)
// when a specific action occurs, such as completing a calculation.
// This helps separate the business logic from the UI and promotes reusable, event-driven design.
